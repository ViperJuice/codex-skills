#!/usr/bin/env bash
# Install codex-skills into $HOME/.codex/skills/ or a project-local skills dir.
#
# Usage:
#   ./install.sh              # install to $HOME/.codex/skills/
#   ./install.sh .codex      # install to ./.codex/skills/ for a project
...
echo "Installing codex-skills to: $SKILLS_DIR"
