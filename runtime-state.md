...
Codex skills store reflections, handoffs, and generated plans in repo-scoped runtime paths so unrelated repos, branches, worktrees, and runs do not collide.
...
- Reflection: `~/.codex/skills/<skill>/reflections/<repo_hash>/<branch_slug>/<run_id>.md`
- Handoff: `~/.codex/skills/<skill>/handoffs/<repo_hash>/<branch_slug>/<run_id>.md`
- Latest handoff pointer: `~/.codex/skills/<skill>/handoffs/<repo_hash>/<branch_slug>/latest.md`
- Plan output, when runtime-local: `~/.codex/skills/<skill>/plans/<repo_hash>/<branch_slug>/<run_id>.md`
...
5. Do not write Claude runtime paths from Codex skills.
...
2. Read `~/.codex/skills/<predecessor>/handoffs/<repo_hash>/<branch_slug>/latest.md`.
...
- `~/.codex/skills/<skill>/reflections/**`
- `codex-config/skills/<skill>/reflections/**`
